...
async function getConfig() {
  ...
  if (!config.gcpProjectId) {
    throw new Error('gcp-project-id is required. Provide it explicitly, via service account key file, or set GOOGLE_CLOUD_PROJECT environment variable when using Workload Identity Federation.');
  }
